...
# Import from src as package
from features.value import value_score
...
value_score = value_module.value_score
backtest_top_n = backtest_module.backtest_top_n
sharpe_ratio = metrics_module.sharpe_ratio
max_drawdown = metrics_module.max_drawdown
plot_equity_curve = viz_module.plot_equity_curve
...
# -----------------------------
# Factor Calculation (MVP: Value only)
# -----------------------------
book_values = prices / 3  # placeholder fundamentals
